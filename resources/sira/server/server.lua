...
Config.Priority = {
    ["steam:110000109a6367a"] = 100,
	["STEAM_0:1:53239237"] = 100
...
Config.Language = {
    ...
    steam = "Şu Steam ı açmayı bi unutmasanız olmuyor değilmi?",
    prio = "İletişim için buyrun https://discord.gg/KRmwHqg:",
}
-----------------------------------------------------------------------------------------------------------------------
