...
local decorName = nil
local decorInt = nil
RegisterNetEvent("hakanonur:HereAreYourDecors")
AddEventHandler("hakanonur:HereAreYourDecors", function( decorN, decorI)
	decorName = decorN
	decorInt = decorI
end)
...
RegisterCommand("e",function(source, args)
	...
	DecorSetInt(prop_name,decorName,decorInt)
		...
		if tostring(args[1]) ~= nil then
			...
			elseif argh == 'not' then
				...
				DecorSetInt(prop,decorName,decorInt)
						...
						DecorSetInt(cigar_name,decorName,decorInt)
						DecorSetInt(secondaryprop_name,decorName,decorInt)
						DecorSetInt(secondaryprop,decorName,decorInt)
