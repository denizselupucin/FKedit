...
positions = {
    {{-129.98, 6551.1, 28.39}, {-1902.68, -573.42, 17.9, 0}, "Kapıyı açmak için E tuşuna basınız."}, -- Outside the Sheriff's Station
    {{-106.3, 6334.36, 30.44, 0}, {151.38, -1007.53, -100.2, 0}, "Odanın kapısını açmak için E tuşuna basınız."},
    --[[
