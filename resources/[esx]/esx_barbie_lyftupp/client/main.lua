...
function OpenActionMenuInteraction(target)
	...
	table.insert(elements, {label = ('Kucağına Al'), value = 'drag'})
...
Citizen.CreateThread(function()
  while true do
    Citizen.Wait(0)
    if IsControlJustReleased(118, Keys['N9']) and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'action_menu') then
