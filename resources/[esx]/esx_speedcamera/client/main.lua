...
local blips = {
	-- 60KM/H ZONES
	{title="Speedcamera (60KM/H)", colour=1, id=1, x = 184.66, y = 6538.59, z = 31.37}, -- 60KM/H ZONE
	{title="Speedcamera (60KM/H)", colour=1, id=1, x = 175.66, y = 6552.06, z = 289.6}, -- 60KM/H ZONE
	{title="Speedcamera (60KM/H)", colour=1, id=1, x = -88.11, y = 6284.53, z = 31.31}, -- 60KM/H ZONE
	{title="Speedcamera (60KM/H)", colour=1, id=1, x = -98.86, y = 6287.79, z = 31.35},-- 60KM/H ZONE
	{title="Speedcamera (60KM/H)", colour=1, id=1, x = -391.02, y = 5987.95, z = 31.54},-- 60KM/H ZONE
	{title="Speedcamera (60KM/H)", colour=1, id=1, x = -385.2, y = 5982.9, z = 31.54},-- 60KM/H ZONE
...
local Speedcamera60Zone = {
    {x = 184.66, y = 6538.59, z = 31.37},
	{x = 175.66, y = 6552.06, z = 289.6},
	{x = -98.86, y = 6287.79, z = 31.35},
	{x = -88.11, y = 6284.53, z = 31.31},
	{x = -391.02, y = 5987.95, z = 31.54},
	{x = -385.2, y = 5982.9, z = 31.54},
}
						...
						if (GetPedInVehicleSeat(playerCar, -1) == playerPed) then					
							if hasBeenCaught == false then
								...
								-- VEHICLES ABOVE ARE BLACKLISTED
									...
									TriggerEvent("pNotify:SendNotification", {text = "Hız Sınırını Aştığın İçin Ceza Yedin!", type = "error", timeout = 5000, layout = "centerLeft"})
