...
Config.Zones = {
    ls1 = {
        Pos   = { x = 1175.56, y = 2640.18, z = 37.27},
...
function GetNeons()
	local neons = {
	    ...
	    { label = "Gri", 	r = 112, 	g = 128, 	b = 144},
	    { label = "Mavi", 			r = 0, 		g = 0, 		b = 255},
	    { label = "Açık Mavi", 	r = 0, 		g = 150, 	b = 255},
	    { label = "Deniz Mavisi", 		r = 0, 		g = 0, 		b = 128},
	    { label = "Gökyüzü Mavisi", 		r = 135, 	g = 206, 	b = 235},
	    { label = "Turkuaz", 		r = 0, 		g = 245, 	b = 255},
	    { label = "Yeşil", 	r = 50, 	g = 255, 	b = 155},
	    { label = "Limon Yeşili", 	r = 0, 		g = 255, 	b = 0},
	    { label = "Zeytin Yeşili", 			r = 128, 	g = 128, 	b = 0},
...
Config.Menus = {
	...
	cosmetics = {
		...
		wheels = _U('wheels'),
		modPlateHolder   	= 'Arka Plaka',
		modVanityPlate   	= 'Ön Plaka',
		modTrimA    		= 'İç işleri',
		modOrnaments    	= 'Süsler',
		modDashboard    	= 'Panolar',
		modDial    			= 'Hızölçerler',
		modDoorSpeaker    	= 'Araba Kapısı',
		modSeats    		= 'Koltuklar',
		modSteeringWheel    = 'Direksiyon',
		modShifterLeavers   = 'Vites Kolu',
		modAPlate    		= 'Arka Aralık',
		modSpeakers    		= 'Sono',
		modTrunk    		= 'Göğüsler',
		modHydrolic    		= 'Hidrolikler',
		modEngineBlock    	= 'Motor Blokları',
		modAirFilter    	= 'Hava Filtreleri',
		modStruts    		= 'Destekler',
		modArchCover    	= 'Önbellek',
		modAerials    		= 'Antenler',
		modTrimB    		= 'Kanatlar',
		modTank    			= 'Rezervuar',
		modWindows    		= 'Pencere',
		modLivery    		= 'Çıkartmalar'
	},
