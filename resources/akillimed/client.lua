...
AddEventHandler('esx:onPlayerDeath', function(data)
	...
	if (bone == 31086) then
		multi = 0.0
		print('HEADSHOT')
		TriggerEvent('chatMessage', "MedSystem", {255, 0, 0}, "Kafa Bölgesinden Vurulduğunu Gördünüz")
		bleeding = 5
		area = "HEAD"
	end
	if bone == 24817 or bone == 24818 or bone == 10706 or bone == 24816 or bone == 11816 then
		multi = 1.0
		print('BODYSHOT')
		TriggerEvent('chatMessage', "MedSystem", {255, 0, 0}, "Gövdeden Vurulduğunu Gördünüz")
		bleeding = 2
		area = "BODY"
	end
...
AddEventHandler('medSystem:near', function(x,y,z, pulse, blood, nameF, nameL, area, bldn)
	...
	if GetDistanceBetweenCoords(x,y,z,a,b,c,false) < 10 then
		timer = 10
		TriggerEvent('chatMessage', "MedSystem", {255,0 , 0}, "Hastaneye İhtiyacım Var Sağlıklı Biri Yardım Etsin Lütfen")
		cBlood = blood
		cPulse = pulse
		cNameF = nameF
		cNameL = nameL
